...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("Asuraa/assets/font2.ttf", 30)
    font = ImageFont.truetype("Asuraa/assets/font.ttf", 30)
    title_font = ImageFont.truetype("Asuraa/assets/font3.ttf", 45)
    ...
    draw.text((10, 10), f"NYKAA MUSIC", fill="white", font=font)
    ...
    play_icons = Image.open("Asuraa/assets/play_icons.png")
