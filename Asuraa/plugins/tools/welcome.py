...
from Asuraa.utils.daxx_ban import admin_filter
...
import asyncio
import time
from Asuraa.utils.database import add_served_chat
from pyrogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton
from Asuraa.utils.database import get_assistant
import asyncio
from Asuraa.misc import SUDOERS
from Asuraa.mongo.afkdb import PROCESS
from pyrogram import Client, filters
...
from Asuraa.utils.database import get_assistant, is_active_chat
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("Asuraa/assets/WEL2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((635, 635))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('Asuraa/assets/font.ttf', size=70)
    welcome_font = ImageFont.truetype('Asuraa/assets/font.ttf', size=61)
